...
// 특정 거래처 정보 직전년도 데이터 가져오기
export const getOrdererPastDataById = ({ id }) => {
  return axios.get("/api/orderer/" + id + "/past");
};

// 특정 거래처 정보 수정하기
export const modifyOrderer = (
  id,
  { name, phone, address, manager, manager_phone, def_ribtext, description }
) => {
